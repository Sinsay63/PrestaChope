                    ...
                    <div class="center">
                        <div class="email">
                            ...
                            <form id="form3" method="post" action="index.php?page=modifProfil">
                                <input type="text" name="info" placeholder="<?php echo $user->getEmail(); ?>" id="espace1"/>
                        ...
                        <div class="pseudo">
                            ...
                            <form id="form4" method="post" action="index.php?page=modifProfil">
                                <input type="text" name="info" placeholder="<?php echo $user->getPseudo(); ?>"id="espace1"/>
                        ...
                        <div class="password">
                            ...
                            <form id="form9" method="post" action="index.php?page=modifProfil">
                                <input type="password" name="info[]" placeholder="Ancien mot de passe"id="espace1"/>
                                <input type="password" name="info[]" placeholder="Nouveau mot de passe"id="espace1"/>
                                <input type="password" name="info[]" placeholder="Retapez mot de passe" id="espace1"/>
                    ...
                    if (!empty($client)) {
                        ?>
                            <div class="adresse">
                                ...
                                <form id="form5" method="post" action="index.php?page=modifProfil">
                                    <input type="text" name="info[]" placeholder="<?php echo $client->getAdresse(); ?>" id="espace1"/>
                                    <input type="text" name="info[]" placeholder="<?php echo $client->getVille(); ?>"id="espace1"/>
                                    <input type="text" name="info[]" placeholder="<?php echo $client->getCp(); ?>"id="espace1"/>
                            ...
                            <div class="téléphone">
                                ...
                                <form id="form6" method="post" action="index.php?page=modifProfil">
                                    <input type="text" name="info" placeholder="<?php echo $client->getTelephone(); ?>" id="espace1"/>
                        ...
                        <div class="adresse">
                            ...
                            <form id="form7" method="post" action="index.php?page=modifProfil">
                                <input type="text" name="info[]" placeholder="Adresse" id="espace1"/>
                                <input type="text" name="info[]" placeholder="Ville" id="espace1"/>
                                <input type="text" name="info[]" placeholder="Code postal" id="espace1"/>
                                <input type="hidden" name="type" value="adresse">
                        ...
                        <div class="téléphone">
                            ...
                            <form id="form8" method="post" action="index.php?page=modifProfil">
                                <input type="text" name="info" placeholder="Votre numéro de téléphone" id="espace1"/>
                                <input type="hidden" name="type" value="telephone">
